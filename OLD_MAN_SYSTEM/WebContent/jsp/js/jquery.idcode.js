/**
 * idcode 1.0 - validate user. Version 1.0
 * 
 * @requires jQuery v1.2 author ehong[idehong@gmail.com]
 */
...
( function( $ ) {
	...
	function _setStyle( codeObj ) {
		...
		for ( var i = 0; i < codeObj.length; i++ ) {
			...
			fnCodeObj.push( '<font color="' + col[charIndex] + '">' + codeObj.charAt( i ) +
					'</font>' );
		}
	...
	function _createCodeCalc( codeLength ) {
		...
		return [
				parseInt( code1 ), parseInt( code2 ), parseInt( code1 ) + parseInt( code2 )
		];
	}
